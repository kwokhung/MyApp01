define("dijit/_editor/RichText", [
	...
	"dojo/query", // query
	"dojo/domReady",
	"dojo/sniff", // has("ie") has("mozilla") has("opera") has("safari")  true 
	...
	var RichText = declare("dijit._editor.RichText", [_Widget, _CssStateMixin], {
		...
		_getIframeDocTxt: function(){
			...
			var html = "";
			var setBodyId = true;
			if(has("ie") ||  true  || (!this.height && !has("mozilla"))){
...
//				}
		...
		_unlinkImpl: function(argument){
			...
			// tags:
			//		protected
			if((this.queryCommandEnabled("unlink")) && (has("mozilla") ||  true )){
