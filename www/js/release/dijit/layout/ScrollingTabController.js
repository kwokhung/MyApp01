define("dijit/layout/ScrollingTabController", [
	...
	"dojo/on",
	"dojo/query", // query
	"dojo/sniff", // has("ie"),  true , has("quirks")
	...
	var ScrollingTabController = declare("dijit.layout.ScrollingTabController", [TabController, _WidgetsInTemplateMixin], {
		...
		_getScroll: function(){
			...
			return (this.isLeftToRight() || has("ie") < 8 || (has("ie") && has("quirks")) ||  true ) ? this.scrollNode.scrollLeft :
		...
		_convertToScrollLeft: function(val){
			...
			if(this.isLeftToRight() || has("ie") < 8 || (has("ie") && has("quirks")) ||  true ){
				return val;
			}else{
